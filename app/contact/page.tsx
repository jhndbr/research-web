        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="glass-card p-8 mb-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-foreground mb-1">Research Areas</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-foreground mb-1">Collaboration Opportunities</h3>
          ...
          <div className="glass-card p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Link 
                href="/research"
                className="inline-flex items-center justify-start px-4 py-2 border border-border rounded-md text-foreground hover:bg-accent transition-colors"
              >
